/**
 * RenderDebugPanel.java
 *
 * <p>Debug panel that exposes runtime toggles for render overlays. Provides checkboxes to
 * enable/disable Box2D physics wireframes, lighting (RayHandler), and the leader-marker circle.
 * Reads and writes the shared {@link RenderDebugSettings} instance each frame.
 *
 * <p>Proyecto: ProyectoM Autor: AlejandroGM0 Fecha: 2026-03-28
 */
