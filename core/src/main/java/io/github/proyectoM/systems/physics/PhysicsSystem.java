 ...
 * PhysicsSystem.java
 *
 * <p>An ECS system responsible for advancing the Box2D physics simulation: - Accumulates simulation
 * time and performs fixed steps to maintain stability. - Must be executed before synchronization
 * and rendering systems.
 *
 * <p>This system inherits from EntitySystem because it performs a global operation of advancing the
 * Box2D physics simulation without needing to process entities individually.
 *
 * <p>Project: ProjectM Author: AlejandroGM0 Date: 2025-06-25
 */
