 ...
 * WaveSystem.java
 *
 * <p>A system responsible for managing the game's time-based waves. It directly modifies the
 * WaveComponent of the global state entity. This system inherits from EntitySystem because it
 * manages the global state of waves without processing individual entities.
 *
