/**
 * TargetSyncSystem.java
 *
 * <p>An ECS system that synchronizes the primary weapon's target to the character's
 * TargetComponent. This allows movement and combat systems (EnemyMovementSystem, LookAtSystem,
 * etc.) to access the current target without directly accessing the weapon entity.
 *
 * <p>Processes all characters (companions and enemies) that have both InventoryComponent and
 * TargetComponent, copying the primary weapon's target to the character's TargetComponent each
 * frame.
 *
 * <p>Project: ProjectM Author: AlejandroGM0 Date: 2025-12-13
 */
