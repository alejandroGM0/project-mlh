/**
 * SquadMovementSystem.java
 *
 * <p>Class SquadMovementSystem.
 *
 * <p>Project: ProjectM Author: AlejandroGM0 Date: 2026-03-26
 */
/**
 * SquadMovementSystem.java
 *
 * <p>An ECS system responsible for moving all troops in formation.
 *
 * <p>This system inherits from EntitySystem because its responsibility is to coordinate and update
 * the global movement of the group (not to process entities one by one in an IteratingSystem). It
 * maintains its own state (list of members, virtual control entity) and listens for recruitment
 * events.
 *
 * <p>The control entity (GroupControllerComponent) is virtual: it has no sprite or physical body.
 * It has a PositionComponent (position of the virtual leader) and a SquadMovementComponent
 * (movement configuration). The InputSystem directly updates the position of the GroupController,
 * and this system moves the troops while maintaining their offsets relative to that position.
 *
 * <p>Project: ProjectM Author: AlejandroGM0 Date: 2025-10-22
 */
